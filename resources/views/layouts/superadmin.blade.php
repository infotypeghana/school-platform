  ...
  <aside class="w-64 bg-gray-900 text-white flex flex-col flex-shrink-0">
    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5">
      @foreach([
        ...
        ['superadmin.packages',           'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10', 'Packages'],
        ['superadmin.invoices',           'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z', 'Invoices'],
